                ...
                if (!Cookies.get("onep21-alert")) {
                  ...
                  <?php if( get_field('onep21_use_dynamic_height','option') == true && get_field('onep21_dynamic_height','option')): ?>
                    jQuery(window).on('resize load', function(e) {
                        var divHeight = jQuery('#onep21-alertbar').height(); 
                        jQuery("<?php the_field('onep21_dynamic_height','option');?>").css('margin-top', 20 + divHeight+'px');
                    });
                    <?php endif; ?>
                  ...
                  $("#onep21-close").click(function () {
                    ...
                    <?php if( get_field('onep21_use_dynamic_height','option') == true && get_field('onep21_dynamic_height','option')): ?>
                    $("<?php the_field('onep21_dynamic_height','option');?>").css('margin-top', '0px');
                    <?php endif; ?>
                  });
                }            
            });
