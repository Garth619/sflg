...
/* support nav type
--------------------------------------------------------------------------------------- */
	add_filter('acf_quick_edit_fields_types','_ilaw_sm_add_nav_menu_supported_cols');
	function _ilaw_sm_add_nav_menu_supported_cols($types){
	...
	//editable form field or some shakalaka 
